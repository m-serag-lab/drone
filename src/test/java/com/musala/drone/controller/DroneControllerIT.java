...
public class DroneControllerIT {
    ...
    @Test
    void test_listAvailable_thenValidateMapping() throws Exception {
    ...
    void test_get_thenValidateMapping() throws Exception {
        mvc.perform(get("/drones/1001"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.serial_number", Matchers.is("1001")))
                .andExpect(jsonPath("$.battery_percentage", Matchers.is(100.0)))
                .andExpect(jsonPath("$.state", Matchers.is("IDLE")))
                .andExpect(jsonPath("$.max_weight", Matchers.is(100.0)))
                .andExpect(jsonPath("$.model", Matchers.is("LIGHT")));
    }
